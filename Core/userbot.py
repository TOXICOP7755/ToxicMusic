...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("NIGHT_CLUB_XD")
                await self.one.join_chat("KNOW_UR_JIJA")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("NIGHT_CLUB-XD")
                await self.two.join_chat("KNOW_UR_JIJA")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("NIGHT_CLUB_XD")
                await self.three.join_chat("KNOW_UR_JIJA")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("NIGHT_CLUB_XD")
                await self.four.join_chat("KNOW_UR_JIJA")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("NIGHT_CLUB_XD")
                await self.five.join_chat("KNOW_UR_JIJA")
            except:
                pass
            assistants.append(5)
